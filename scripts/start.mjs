...
//   STATIC_DIR  Built frontend assets dir.                 (default <repo>/artifacts/reportready/dist/public)
...
const staticDir =
  process.env.STATIC_DIR || path.resolve(appDir, 'artifacts', 'reportready', 'dist', 'public');
const apiEntry =
